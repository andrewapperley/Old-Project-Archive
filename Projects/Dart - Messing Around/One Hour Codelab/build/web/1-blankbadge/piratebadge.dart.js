...
["", "piratebadge.dart", , A, {
  ...
  updateBadge: [function(e) {
    var newName, t1, t2;
    newName = H.interceptedTypeCast(J.get$target$x(e), "$isInputElement").value;
    A.setBadgeName(A.PirateName$(null, newName));
    t1 = J.trim$0$s(newName);
    t2 = $.genButton;
    if (t1.length === 0) {
  ...
  PirateName: {
    ...
    PirateName$2$appellation$firstName: function(appellation, firstName) {
      var t1;
      if (firstName == null)
        this._firstName = J.$index$asx($.get$PirateName_names(), $.get$PirateName_indexGen().nextInt$1(J.get$length$asx($.get$PirateName_appellations())));
      else
