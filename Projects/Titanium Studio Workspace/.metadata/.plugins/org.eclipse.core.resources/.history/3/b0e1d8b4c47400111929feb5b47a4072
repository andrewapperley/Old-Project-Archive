...
var adminEventReq = Titanium.Network.createHTTPClient();

var theEvents = Titanium.UI.createTextArea({editable:false, top:0, width:300, textAlign:"center", backgroundColor:'none', font:{fontFamily:'Day Roman', fontSize:12}});
var eventScroll = Titanium.UI.createScrollView({top:200, height:225, width:300})
var memberEventTitle = Titanium.UI.createLabel({font:{fontFamily:'Day Roman', fontSize:20}});
var adminEventTitle = Titanium.UI.createLabel({font:{fontFamily:'Day Roman', fontSize:20}});
...
events.add(title);
events.add(footer);
adminEventReq.open('GET', "http://client.andrewapperley.ca/app_events_admin.php");
adminEventReq.send();
...
var footer = Titanium.UI.createLabel({
	...
	left:50, 
	color:'#a3a3a3',
	font:{fontFamily:'SF Movie Poster',fontSize:28}
});
