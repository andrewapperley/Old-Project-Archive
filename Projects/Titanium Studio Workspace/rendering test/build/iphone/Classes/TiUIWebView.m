...
static NSString * const krenderingtestJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_renderingtestInjection
{
	...
	[html appendString:krenderingtestJavascript];
...
{
	// attempt to make well-formed HTML and inject in our renderingtest bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _renderingtestInjection]];
