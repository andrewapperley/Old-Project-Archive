...
@interface renderingtestObject : KrollCoverageObject {
#else
@interface renderingtestObject : KrollObject {
#endif
@private
...
extern NSString * renderingtest$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	renderingtestObject *_renderingtest;
    KrollObject* console;
	BOOL shutdown;
