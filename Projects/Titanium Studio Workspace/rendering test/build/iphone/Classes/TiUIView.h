...
/**
 Base class for all renderingtest views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the renderingtest view hierarchy (such as wrapped iOS UIViews) was touched.
