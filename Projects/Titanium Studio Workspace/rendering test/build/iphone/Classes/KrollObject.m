...
//@interface renderingtestObject : NSObject
//@end

@interface renderingtestObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[renderingtestObject class]])
		{
			for (NSString *key in [[(renderingtestObject*)o modules] allKeys])
			{
