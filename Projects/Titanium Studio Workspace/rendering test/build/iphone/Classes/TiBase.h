...
// in simulator we redefine to format for renderingtest Developer console
...
{\
	NSString * exceptionName = [@"org.renderingtest." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.renderingtest";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIrenderingtestNativeItemNone = -1, 
	UIrenderingtestNativeItemSpinner = -2,
	UIrenderingtestNativeItemProgressBar = -3,
	
	UIrenderingtestNativeItemSlider = -4,
	UIrenderingtestNativeItemSwitch = -5,
	UIrenderingtestNativeItemMultiButton = -6,
	UIrenderingtestNativeItemSegmented = -7,
	
	UIrenderingtestNativeItemTextView = -8,
	UIrenderingtestNativeItemTextField = -9,
	UIrenderingtestNativeItemSearchBar = -10,
	
	UIrenderingtestNativeItemPicker = -11,
	UIrenderingtestNativeItemDatePicker = -12,
	
	UIrenderingtestNativeItemInfoLight = -13,
	UIrenderingtestNativeItemInfoDark = -14,
	
	UIrenderingtestNativeItemDisclosure = -15,
	
	UIrenderingtestNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all renderingtest instances of
