...
//Rare exceptions to indicate a bug in the _renderingtest code (Eg, function that a subclass should have implemented)
...
/**
 The base class for renderingtest proxies.
 */
