...
@interface HumberGradShowObject : KrollCoverageObject {
#else
@interface HumberGradShowObject : KrollObject {
#endif
@private
...
extern NSString * HumberGradShow$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	HumberGradShowObject *_humbergradshow;
	BOOL shutdown;
