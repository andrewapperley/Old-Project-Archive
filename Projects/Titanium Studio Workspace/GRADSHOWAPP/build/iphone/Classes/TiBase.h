...
// in simulator we redefine to format for HumberGradShow Developer console
...
{\
	NSString * exceptionName = [@"org.humbergradshow." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.humbergradshow";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIHumberGradShowNativeItemNone = -1, 
	UIHumberGradShowNativeItemSpinner = -2,
	UIHumberGradShowNativeItemProgressBar = -3,
	
	UIHumberGradShowNativeItemSlider = -4,
	UIHumberGradShowNativeItemSwitch = -5,
	UIHumberGradShowNativeItemMultiButton = -6,
	UIHumberGradShowNativeItemSegmented = -7,
	
	UIHumberGradShowNativeItemTextView = -8,
	UIHumberGradShowNativeItemTextField = -9,
	UIHumberGradShowNativeItemSearchBar = -10,
	
	UIHumberGradShowNativeItemPicker = -11,
	UIHumberGradShowNativeItemDatePicker = -12,
	
	UIHumberGradShowNativeItemInfoLight = -13,
	UIHumberGradShowNativeItemInfoDark = -14,
	
	UIHumberGradShowNativeItemDisclosure = -15,
	
	UIHumberGradShowNativeItemContactAdd = -16
};
...
/*
 *	TiThreadPerformOnMainThread should replace all HumberGradShow instances of
