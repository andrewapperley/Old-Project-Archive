 ...
 * Copyright (c) 2009-2011 by HumberGradShow, Inc. All Rights Reserved.
...
//@interface HumberGradShowObject : NSObject
//@end

@interface HumberGradShowObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[HumberGradShowObject class]])
		{
			for (NSString *key in [[(HumberGradShowObject*)o modules] allKeys])
			{
