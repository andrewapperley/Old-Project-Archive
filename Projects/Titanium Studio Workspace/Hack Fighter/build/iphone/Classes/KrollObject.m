 ...
 * Copyright (c) 2009-2011 by HackFighter, Inc. All Rights Reserved.
...
//@interface HackFighterObject : NSObject
//@end

@interface HackFighterObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[HackFighterObject class]])
		{
			for (NSString *key in [[(HackFighterObject*)o modules] allKeys])
			{
