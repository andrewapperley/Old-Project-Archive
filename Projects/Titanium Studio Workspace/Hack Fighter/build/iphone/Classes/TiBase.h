...
// in simulator we redefine to format for HackFighter Developer console
...
{\
	NSString * exceptionName = [@"org.hackfighter." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.hackfighter";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIHackFighterNativeItemNone = -1, 
	UIHackFighterNativeItemSpinner = -2,
	UIHackFighterNativeItemProgressBar = -3,
	
	UIHackFighterNativeItemSlider = -4,
	UIHackFighterNativeItemSwitch = -5,
	UIHackFighterNativeItemMultiButton = -6,
	UIHackFighterNativeItemSegmented = -7,
	
	UIHackFighterNativeItemTextView = -8,
	UIHackFighterNativeItemTextField = -9,
	UIHackFighterNativeItemSearchBar = -10,
	
	UIHackFighterNativeItemPicker = -11,
	UIHackFighterNativeItemDatePicker = -12,
	
	UIHackFighterNativeItemInfoLight = -13,
	UIHackFighterNativeItemInfoDark = -14,
	
	UIHackFighterNativeItemDisclosure = -15,
	
	UIHackFighterNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all HackFighter instances of
