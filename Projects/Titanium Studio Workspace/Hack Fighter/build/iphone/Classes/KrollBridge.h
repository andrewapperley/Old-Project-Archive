...
@interface HackFighterObject : KrollCoverageObject {
#else
@interface HackFighterObject : KrollObject {
#endif
@private
...
extern NSString * HackFighter$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	HackFighterObject *_hackfighter;
    KrollObject* console;
	BOOL shutdown;
