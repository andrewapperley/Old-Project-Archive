...
static NSString * const kHackFighterJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_hackfighterInjection
{
	...
	[html appendString:kHackFighterJavascript];
...
{
	// attempt to make well-formed HTML and inject in our HackFighter bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _hackfighterInjection]];
