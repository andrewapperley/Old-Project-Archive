...
/**
 Base class for all HackFighter views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the HackFighter view hierarchy (such as wrapped iOS UIViews) was touched.
