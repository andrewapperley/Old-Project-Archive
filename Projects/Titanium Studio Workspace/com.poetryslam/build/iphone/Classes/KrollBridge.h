...
@interface PoetrySlamObject : KrollCoverageObject {
#else
@interface PoetrySlamObject : KrollObject {
#endif
@private
...
extern NSString * PoetrySlam$ModuleRequireFormat;
