 ...
 * Copyright (c) 2009-2011 by PoetrySlam, Inc. All Rights Reserved.
...
//@interface PoetrySlamObject : NSObject
//@end

@interface PoetrySlamObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[PoetrySlamObject class]])
		{
			for (NSString *key in [[(PoetrySlamObject*)o modules] allKeys])
			{
