...
// in simulator we redefine to format for PoetrySlam Developer console
...
{\
	NSString * exceptionName = [@"org.poetryslam." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.poetryslam";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIPoetrySlamNativeItemNone = -1, 
	UIPoetrySlamNativeItemSpinner = -2,
	UIPoetrySlamNativeItemProgressBar = -3,
	
	UIPoetrySlamNativeItemSlider = -4,
	UIPoetrySlamNativeItemSwitch = -5,
	UIPoetrySlamNativeItemMultiButton = -6,
	UIPoetrySlamNativeItemSegmented = -7,
	
	UIPoetrySlamNativeItemTextView = -8,
	UIPoetrySlamNativeItemTextField = -9,
	UIPoetrySlamNativeItemSearchBar = -10,
	
	UIPoetrySlamNativeItemPicker = -11,
	UIPoetrySlamNativeItemDatePicker = -12,
	
	UIPoetrySlamNativeItemInfoLight = -13,
	UIPoetrySlamNativeItemInfoDark = -14,
	
	UIPoetrySlamNativeItemDisclosure = -15,
	
	UIPoetrySlamNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all PoetrySlam instances of
