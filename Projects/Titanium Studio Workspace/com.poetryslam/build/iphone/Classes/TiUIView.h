...
/**
 Base class for all PoetrySlam views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the PoetrySlam view hierarchy (such as wrapped iOS UIViews) was touched.
